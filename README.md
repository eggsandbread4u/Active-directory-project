...
Learn how to set up DC, Client PC, users, groups, and manage them.

---

## Project Overview 📌
This project shows core active directory management task:
* Deploying a **Window Server 2025** Domain Controller.
...
### Step 1: Set up a domain controller (DC) and a client PC
...
2. You'll see a bunch of folders click on your domain and make a OU folder. Inside that OU folder make sub-OU folders 'IT' and 'sales'
...
3. Now right click one of the folders and make a user inside them. A window will pop up that will ask you to set up the user name and password and also the user ID
...
4. Once you've created a user you can click on it and make new changes if you wish to
...
### Step 4: Logging in as the new user
